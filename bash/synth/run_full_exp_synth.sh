...
python ./experiments/synth/Step1_GenDataByDifficulty.py -n 150 -f "synth/full"
...
python ./experiments/synth/Step1_GenDataByNoise.py -n 50 -f "synth_noisy/full"
echo "Step 1: Split noisy synth data..."
python ./experiments/synth/Step1_TrainTestSplit.py -f "data/synth_noisy/full" -o "data/synth_noisy"

echo "Step 2: Running FALFA on noisy data..."
python ./experiments/synth/Step2_FALFA_NN.py -f "./data/synth_noisy/" -o "./results/synth_noisy"
echo "Step 3: Computing C-Measures on noisy data FALFA NN..."
...
echo "Step 4: Save noisy data to meta-database..."
...
echo "Step 2: Running ALFA on noisy data..."
python ./experiments/synth/Step2_ALFA_SVM.py -f "./data/synth_noisy/" -o "./results/synth_noisy"
echo "Step 3: Computing C-Measures on noisy data ALFA SVM..."
