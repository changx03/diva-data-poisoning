...
python ./experiments/real/svm/step2_train_attack.py -f ./data/preprocessed/abalone.csv -o ./data/output -t 0.2 -s 0.05
...
python ./experiments/real/svm/step2_train_attack.py -f ./data/preprocessed/htru2.csv -o ./data/output -t 0.2 -s 0.05
python ./experiments/real/svm/step2_train_attack.py -f ./data/preprocessed/phoneme.csv -o ./data/output -t 0.2 -s 0.05
python ./experiments/real/svm/step2_train_attack.py -f ./data/preprocessed/ringnorm.csv -o ./data/output -t 0.2 -s 0.05
