...
python ./experiments/real/nn/step2_train_attack.py -f ./data/preprocessed/abalone_subset.csv -o ./data/output -t 0.2 -s 0.05
...
python ./experiments/real/nn/step2_train_attack.py -f ./data/preprocessed/htru2_subset.csv -o ./data/output -t 0.2 -s 0.05
python ./experiments/real/nn/step2_train_attack.py -f ./data/preprocessed/phoneme_subset.csv -o ./data/output -t 0.2 -s 0.05
python ./experiments/real/nn/step2_train_attack.py -f ./data/preprocessed/ringnorm_subset.csv -o ./data/output -t 0.2 -s 0.05
